...
export function IntegratedFlow({ children, className }: { children: React.ReactNode; className?: string }) {
  return <div data-slot="integrated-flow" className={cn("ui-flow relative flex flex-col gap-8 before:absolute before:bottom-5 before:left-[1.12rem] before:top-5 before:hidden before:w-px before:bg-border/80 sm:gap-10 sm:before:block", className)}>{children}</div>;
}
...
export function PageHeader({
  ...
  return (
    <header data-slot="page-header" className={cn("ui-page-header page-header flex flex-col gap-4 border-b border-border/75 pb-5 sm:flex-row sm:items-end sm:justify-between", className)}>
...
export function SectionLabel({
  ...
  return (
    <div data-slot="section-header" className={cn("ui-section-label mb-3 flex min-w-0 items-center justify-between gap-3", className)}>
  ...
  return (
    <div className={cn("flex flex-col gap-1", className)}>
      ...
      <div className="flex items-baseline gap-1">
        <span className="ui-metric-value font-display text-2xl font-bold leading-none tabular" style={color}>
          {value}
        </span>
...
export function Ring({
  ...
  return (
    <div
      ...
      aria-valuemax={100}
    >
      <svg width={size} height={size} className="ui-ring -rotate-90" aria-hidden="true">
...
export function MacroBar({
  ...
  return (
    <div className={cn("flex flex-col gap-1.5", className)}>
      ...
      <div className="ui-progress-track h-2 overflow-hidden rounded-full bg-secondary">
        <div
...
export function EmptyState({
  ...
  return (
    <div className="ui-empty-state flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-border bg-card px-5 py-8 text-center sm:px-6 sm:py-10">
