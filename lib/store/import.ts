...
export function analizarImportacion(valor: unknown, actual: StoreData): ResumenImportacion {
  const vacio: ResumenImportacion = { valido: false, version: null, exportado: null, diasNuevos: 0, diasCoincidentes: 0, medicionesNuevas: 0, medicionesCoincidentes: 0, comidas: 0 };
  ...
  if (archivo.version !== undefined && (!Number.isInteger(archivo.version) || archivo.version < 1 || archivo.version > 1)) return { ...vacio, error: "La versión de este respaldo no es compatible todavía." };
