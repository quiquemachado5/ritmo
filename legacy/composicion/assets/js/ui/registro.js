...
function tarjetaCalendario(estado) {
  ...
  return `<article class="card card--habit-calendar w-5">
    ...
    <div class="legend" style="margin-top:14px">
      <span class="legend__item"><span class="legend__swatch" style="background:var(--habit-soft)"></span>Parcial</span>
      <span class="legend__item"><span class="legend__swatch" style="background:var(--habit)"></span>Completo</span>
